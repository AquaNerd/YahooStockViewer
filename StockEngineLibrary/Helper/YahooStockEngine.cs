...
namespace StockEngineLibrary.Helper {
    public class YahooStockEngine {
        ...
        public static void Fetch(ObservableCollection<ObservableQuote> quotes) {
        ...
        private static void Parse(ObservableCollection<ObservableQuote> quotes, XDocument doc) {
            XElement results = doc.Root.Element("results");

            foreach (ObservableQuote quote in quotes) {
